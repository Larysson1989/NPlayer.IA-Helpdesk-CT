...
/** Retorna cópia de todos os usuários (sem expor o array original) */
export function getAllUsers(): UserRecord[] {
  return USERS.map(u => ({ ...u }));
}

/** Atualiza campos de um usuário pelo e-mail */
...
/** Painel Administrativo — supervisor e administrador */
