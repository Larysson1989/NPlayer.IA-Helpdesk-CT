...
- Gravação obrigatória (checklist Selbetti), exceto para Copel via Multicanal ou link de LP.
...
=== MULTICANAL (WHATSAPP) ===
- Válido para Copel (dispensa checklist gravado em áudio se houver o texto padrão de autorização e o print anexado no Bell).
- Para Celesc e Débito Automático: exige OBRIGATORIAMENTE o retorno de ligação telefônica para registrar o checklist gravado em voz.
...
- Toda doação exige gravação com checklist via Weon (exceções: LP e Multicanal - Copel).
...
- Copel: Dispensa checklist gravado em áudio se houver o texto padrão de autorização e o print da conversa anexado no Bell com todos os dados cadastrais.
- Celesc e Débito Automático: Exige obrigatoriamente o retorno de ligação telefônica para gravação do rito do checklist em voz.
...
- Permitida SOMENTE em casos de: internação, cirurgia ou dificuldade de locomoção.
- O colaborador deve:
